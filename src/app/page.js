                      ...
                      >
                        ...
                        <div className="flex justify-between items-center mb-4">
                          ...
                          <div className="flex items-center gap-2">
                            {m.sets && m.sets.length > 0 && (
                              <span className="text-[10px] font-black bg-purple-900/50 text-purple-300 px-2 py-0.5 rounded border border-purple-700 uppercase">
                                Sets Won: {m.scoreA} - {m.scoreB}
                              </span>
                            )}
                        ...
                        {/* --- NEW: COMPLETED SETS RIBBON FOR LIVE MATCHES --- */}
                        {m.sets && m.sets.length > 1 && (
                          <div className="mb-4 bg-slate-950/60 border border-slate-800 p-2 rounded-xl flex items-center gap-2 text-xs text-slate-400 overflow-x-auto">
                            <span className="font-bold text-slate-500 uppercase text-[10px]">
                              Previous Sets:
                            </span>
                            {m.sets.slice(0, m.sets.length - 1).map((s) => (
                              <span
                                key={s.set}
                                className="bg-slate-900 text-slate-300 px-2 py-0.5 rounded font-mono border border-slate-800"
                              >
            ...
            <div className="min-w-[1100px] grid grid-cols-5 gap-6 items-center">
              ...
              <div className="space-y-4">
                ...
                {[1, 2, 3, 4, 5, 6, 7, 8].map((num) => {
                  const match =
                    findMatchByCode(`PQ ${num}`) ||
                    findMatchByCode(`PQ_${num}`);
                  ...
                  return (
                    <div
                      key={num}
                      className="bg-slate-950 border border-slate-800 rounded-lg p-2.5 text-xs font-semibold"
                    >
                      ...
                      <div
                        className={`flex justify-between items-center py-1 px-1.5 rounded ${p1Win ? "bg-sky-900/50 font-black text-white" : "text-slate-400"}`}
                      >
                      ...
                      <div
                        className={`flex justify-between items-center py-1 px-1.5 rounded mt-0.5 ${p2Win ? "bg-sky-900/50 font-black text-white" : "text-slate-400"}`}
                      >
                        <span className="truncate">
              ...
              <div className="space-y-12">
                ...
                {[1, 2, 3, 4].map((num) => {
                  const match =
                    findMatchByCode(`QF ${num}`) ||
                    findMatchByCode(`QF_${num}`);
                  const isComplete = match?.status === "completed";
                  const p1Win =
                    isComplete &&
                    (match.walkover === "A" || match.scoreA > match.scoreB);
                  ...
                  return (
                    <div
                      key={num}
                      className="bg-slate-950 border border-slate-800 rounded-lg p-3 text-xs font-semibold"
                    >
                      ...
                      <div
                        className={`flex justify-between items-center py-1 px-1.5 rounded ${p1Win ? "bg-pink-900/50 font-black text-white" : "text-slate-400"}`}
                      >
                      ...
                      <div
                        className={`flex justify-between items-center py-1 px-1.5 rounded mt-0.5 ${p2Win ? "bg-pink-900/50 font-black text-white" : "text-slate-400"}`}
                      >
                ...
                {[1, 2].map((num) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        className={`flex justify-between items-center py-1.5 px-2 rounded ${p1Win ? "bg-indigo-900/50 font-black text-white" : "text-slate-400"}`}
                      >
                        ...
                        {match?.sets && match.sets.length > 0 ? (
                          <div className="flex gap-1 font-mono text-[10px]">
                            {match.sets.map((s) => (
                              <span
                                key={s.set}
                                className="bg-slate-900 px-1 rounded border border-slate-800"
                              >
                                {s.scoreA}
                              </span>
                            ))}
                      ...
                      <div
                        className={`flex justify-between items-center py-1.5 px-2 rounded mt-1 ${p2Win ? "bg-indigo-900/50 font-black text-white" : "text-slate-400"}`}
                      >
                    ...
                    <div className="bg-slate-950 border border-amber-500/40 rounded-xl p-4 text-xs font-semibold shadow-lg">
                      <div className="text-xs font-black text-amber-400 uppercase mb-2 flex items-center justify-between">
                        <span className="flex items-center gap-1.5">
                          <Trophy size={16} className="text-amber-400" /> FINAL
                        </span>
                        {isComplete && (
                      ...
                      <div
                        className={`flex justify-between items-center py-2 px-2.5 rounded ${p1Win ? "bg-amber-950 font-black text-white text-sm" : "text-slate-400"}`}
                      >
                        <span className="truncate pr-2">{autoP1}</span>
                        {match?.sets && match.sets.length > 0 ? (
                      ...
                      <div
                        className={`flex justify-between items-center py-2 px-2.5 rounded mt-1.5 ${p2Win ? "bg-amber-950 font-black text-white text-sm" : "text-slate-400"}`}
                      >
                        <span className="truncate pr-2">{autoP2}</span>
                        {match?.sets && match.sets.length > 0 ? (
                          <div className="flex gap-1 font-mono text-xs">
