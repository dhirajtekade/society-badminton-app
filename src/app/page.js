...
import { Radio, Calendar, Trophy, Activity, ChevronRight, ListOrdered, Swords } from "lucide-react";
...
export default function PublicLiveView() {
  ...
  // Tab State: 'matches' or 'leaderboard'
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      ...
      snapshot.forEach((doc) => {
        ...
        const hasStarted = (m.scoreA > 0 || m.scoreB > 0);
                    ...
                    <div key={m.id} className="bg-slate-900 border border-slate-700 rounded-2xl p-5 shadow-xl relative overflow-hidden">
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between items-center">
                          ...
                          <div className="text-4xl font-black text-white font-mono bg-slate-950 px-4 py-1 rounded-lg border border-slate-800">{m.scoreA || 0}</div>
                        </div>
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <div className="text-4xl font-black text-white font-mono bg-slate-950 px-4 py-1 rounded-lg border border-slate-800">{m.scoreB || 0}</div>
                        </div>
                      </div>
                    </div>
                  ))}
